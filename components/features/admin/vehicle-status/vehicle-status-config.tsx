...
import { deleteVehicleStatusConfig } from "@/lib/features/vehicle-status";
import type { VehicleStatusConfig as VehicleStatusConfigType } from "@/types/domain/vehicle/types";
