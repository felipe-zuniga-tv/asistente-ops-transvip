...
import { DRIVER_SEARCH_API_URL, DRIVER_PROFILE_API_URL, DRIVER_RATINGS_API_URL } from "@/lib/chat/config/urls"
import { getResponseFromURL, getAssignedVehicles } from "@/lib/chat/utils/helpers"
